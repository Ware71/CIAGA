-- Update get_round_setup_participants to include team_id
...
COMMENT ON FUNCTION public.get_round_setup_participants IS
  'Returns all participants for a round setup page, including handicap fields, assigned HI override, and team assignment.';
