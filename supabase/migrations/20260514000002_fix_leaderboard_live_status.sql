-- Fix invalid 'in_progress' enum value in ciaga_compute_competition_leaderboard.
-- The migration 20260514000001 was already applied with 'in_progress'; this re-runs
-- the function with the correct 'live' status value.
