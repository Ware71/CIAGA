-- Add pending_tee_box_id to get_round_setup_participants for per-player tee display
...
COMMENT ON FUNCTION public.get_round_setup_participants IS
  'Returns all participants for a round setup page, including handicap fields, team assignment, and per-player pending tee box.';
