-- Fix: not_started holes in accepted rounds should contribute NDB to AGS, not 0.
-- Under WHS, any unplayed hole (whether picked_up or not_started) is assigned
-- net double bogey for handicap purposes. Previously NS holes contributed 0,
-- producing an artificially low adjusted gross score and favourable differential.
