-- Update get_round_setup_participants RPC to include handicap fields
-- This avoids the need for a separate query
...
COMMENT ON FUNCTION public.get_round_setup_participants IS
  'Returns all participants for a round setup page, including handicap fields.
   Includes profile data via LEFT JOIN to handle both guests and registered users.';
