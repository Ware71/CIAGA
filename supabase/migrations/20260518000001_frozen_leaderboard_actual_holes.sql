-- ============================================================
-- Add actual_holes_completed to ciaga_get_frozen_leaderboard.
-- This lets the frontend show "thru 13 (16)" — frozen score
-- through hole 13, player is actually at hole 16.
-- Must DROP first: PostgreSQL won't allow CREATE OR REPLACE to
-- change a function's return type signature.
-- ============================================================
