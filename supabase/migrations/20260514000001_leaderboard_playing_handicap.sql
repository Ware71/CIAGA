-- Use playing_handicap_used (allowance applied) instead of course_handicap_used
-- (raw WHS, 100% allowance) when computing competition net scores.
-- Falls back to course_handicap_used for rounds started before playing_handicap_used existed.
