...
import { getEventLeaderboard, getEventSubmissionMap } from "@/lib/majors/queries";
...
export async function POST(req: Request, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    await supabaseAdmin.rpc("ciaga_compute_event_leaderboard", { p_event_id: id });
