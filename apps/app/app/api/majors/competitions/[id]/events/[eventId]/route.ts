...
async function requireAdminOfEventTemplate(profileId: string, eventId: string) {
  ...
  if (!tmpl) return null;
  const groupId = (tmpl as any).competition?.group_id;
...
// PATCH /api/majors/competitions/[id]/events/[eventId] — update event template
export async function PATCH(
  ...
  try {
    ...
    const allowed = [
      ...
      "template_event_type", "template_scoring_model",
...
// DELETE /api/majors/competitions/[id]/events/[eventId] — remove event template
