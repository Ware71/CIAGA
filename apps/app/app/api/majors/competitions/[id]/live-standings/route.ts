...
// Returns a merged leaderboard of all competition participants:
//   - Players with live rounds: computed from current round scores
//   - Players with submitted rounds: from competition_leaderboard_entries
export async function GET(req: Request, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    // 4. For finished rounds: read from competition_leaderboard_entries
