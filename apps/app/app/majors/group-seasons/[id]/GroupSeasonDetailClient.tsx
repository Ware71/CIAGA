  ...
  return (
    <div className="min-h-[100dvh] pb-[env(safe-area-inset-bottom)] max-w-sm mx-auto">
      ...
      <div className="px-4 mb-4 space-y-1">
        ...
        <h1 className="text-xl font-bold text-[#7CF0BE] leading-tight">{season.name}</h1>
              ...
              standings.map((row) => (
                ...
                >
                  ...
                  <div className="text-right shrink-0">
                    <div className="text-xs font-extrabold text-[#7CF0BE]">{row.season_points}</div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {[
                    ...
                    <div key={item.label} className="rounded-xl border border-emerald-900/50 bg-[#0b3b21]/60 px-3 py-2.5">
                      ...
                      <div className={`text-sm font-bold ${item.label === "Pot Balance" && item.value < 0 ? "text-red-400" : "text-[#7CF0BE]"}`}>
                  ...
                  <div key={pot.id} className="rounded-xl border border-emerald-900/50 bg-[#0b3b21]/50 overflow-hidden">
                    <div className="px-3 py-2.5 space-y-2">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        {pot.is_monetary && (
                          <div className="text-sm font-bold text-[#7CF0BE] shrink-0">£{pot.total_pot.toFixed(2)}</div>
                        )}
