            ...
            <tr key={row.profileId} className="border-t border-emerald-900/20">
              ...
              {row.cells.map((cell, i) => (
                <td key={model.columns[i]?.id ?? i} className="px-1 py-1 text-center">
                  {cell ? (
                    <span className="inline-block min-w-[46px] rounded-lg border border-emerald-800/50 bg-emerald-950/40 px-1.5 py-0.5 text-[11px] font-bold text-[#7CF0BE]">
          ...
          <div className="rounded-2xl border border-emerald-900/70 bg-gradient-to-br from-[#0b3b21]/90 to-[#07301a]/90 px-4 py-3.5">
            <div className="flex items-center justify-between">
              <div className="min-w-0">
                <h1 className="text-lg font-bold text-[#7CF0BE] truncate">{group.group.name}</h1>
              ...
              <div className="text-right shrink-0">
                {group.balance !== null && (
                  <div className="text-base font-bold text-[#7CF0BE]">{formatPoints(group.balance)} pts</div>
                )}
          ...
          {season && (
            <section>
              ...
              <button
                ...
                className="w-full text-left rounded-2xl border border-[#7CF0BE]/25 bg-[#0b3b21]/70 px-3.5 py-3 hover:bg-emerald-900/30 transition-colors"
              >
                  ...
                  >
                    ...
                    {e.narrative && (
                      <div className="mt-2 pt-2 border-t border-emerald-900/30">
                        <div className="text-[8px] uppercase tracking-[0.2em] text-[#7CF0BE]/55 mb-0.5">
                          Preview
                        </div>
